...
import MilestoneAddButton from '@/features/projectJob/components/milestone/MilestoneAddButton';
import Milestones from '@/features/projectJob/contents/milestone/Milestones';
import { useMilestones } from '@/entities/milestone/api/getMilestones';
import { useRecoilState, useRecoilValue, useResetRecoilState } from 'recoil';
import { projectIdState } from '@/entities/project/store/ProjectIdStateStore';
import TaskAddButton from '@/features/projectJob/components/task/TaskAddButton';
import Tasks from '@/features/projectJob/contents/task/Tasks';
import { useEffect } from 'react';
import {
  activeMilestoneStateStore,
  DEFAULT_ACTIVE_MILESTONE,
} from '@/entities/milestone/store/ActiveMilestoneStateStore';
import ProjectJobSkeleton from '@/features/projectJob/contents/ProjectJobSkeleton';
import MilestoneModModal from '@/features/projectJob/contents/milestone/MilestoneModModal';
import MilestoneAddModal from '@/features/projectJob/contents/milestone/MilestoneAddModal';
import TaskAddModal from '@/features/projectJob/contents/task/TaskAddModal';
import TaskModModal from '@/features/projectJob/contents/task/TaskModModal';
import TasksSkeleton from '@/features/projectJob/contents/task/TasksSkeleton';
