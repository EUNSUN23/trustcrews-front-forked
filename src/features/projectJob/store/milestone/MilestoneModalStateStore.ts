import { CreateMilestoneInput } from '@/features/projectJob/api/milestone/createMilestone';
import { atom, DefaultValue, selectorFamily } from 'recoil';
import { UpdateMilestoneInput } from '@/features/projectJob/api/milestone/updateMilestone';
