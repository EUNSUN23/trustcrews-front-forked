...
import TrustGradeBadge from '@/entities/trustGrade/components/TrustGradeBadge';
import { useCrewDetail } from '@/features/projectCrewDetail/api/crewProfile/getCrewDetail';
import { crewIdState } from '@/entities/projectCrew/store/CrewIdStateStore';
import { useRecoilValue } from 'recoil';
import CrewOutButton from '@/features/projectCrewDetail/contents/crewProfile/CrewOutButton';
import CrewFwButton from '@/features/projectCrewDetail/contents/crewProfile/CrewFWButton';
import { bigIntToString } from '@/shared/utils/stringUtils';
import { TechStack } from '@/types/data/techStack';
import PMAuthBadge from '@/entities/pmAuth/components/PMAuthBadge';
