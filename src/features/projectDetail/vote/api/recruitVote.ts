...
import { z } from 'zod';
import { RC_VOTE_NOTICE_LIST_QUERY_KEY } from '@/features/projectDetail/notice/api/rcVoteNotice/getRCVoteNoticeList';
import { RCVOTE_NOTICE_QUERY_KEY } from '@/features/projectDetail/notice/api/rcVoteNotice/getRCVoteNotice';
