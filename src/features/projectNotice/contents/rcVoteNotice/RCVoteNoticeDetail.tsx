...
import RCTargetProjectHistory from '@/features/projectNotice/contents/rcVoteNotice/RCTargetProjectHistory';
import VoteBar from '@/entities/projectVote/components/VoteBar';
import { VOTE_OPTIONS } from '@/entities/projectVote/constants/voteOptions';
import {
  recruitVoteAnswerInputSchema,
  useRecruitVote,
} from '@/entities/projectVote/api/recruitVote';
