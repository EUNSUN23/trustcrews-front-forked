...
import {activeBoardTabStore, BOARD_TABS,} from '@/features/board/store/BoardActiveStateStore';
import {ProjectApplyStatus} from "@/features/board/projectApplyStatus";
...
function BoardTabPanel() {
    ...
    return (
        <section>
            ...
            >
                {activeBoardTab === MANAGE_PROJECT && <ProjectApplyStatus/>}
